...
var prevScrollpos=window.scrollY,headerDiv=document.getElementById("header");function changeHeaderStyle(){var e=window.scrollY;prevScrollpos<e&&prevScrollpos>300?(headerDiv.style.top=-headerDiv.offsetHeight+"px",headerDiv.classList.add("fixed")):prevScrollpos<300?(headerDiv.style.top="0",headerDiv.classList.remove("fixed")):(headerDiv.style.top="0",headerDiv.classList.add("fixed")),prevScrollpos=e}if(window.onscroll=function(){changeHeaderStyle()},$("div[data-aos]").length&&AOS.init({disable:"mobile",once:!0}),$(".hero-section-carousel").length)var heroCarousel=new Swiper(".hero-section-carousel ",{passiveListeners:!1,speed:800,autoplay:{delay:15e3},pagination:{el:".hero-section-carousel  .swiper-pagination",clickable:!0}});if($(".latest-news-carousel").length)var latestNewsCarousel=new Swiper(".latest-news-carousel ",{passiveListeners:!1,effect:"cube",speed:800,autoplay:{delay:5e3},loop:!0,mousewheel:{invert:!0},cubeEffect:{shadow:!0,slideShadows:!0,shadowOffset:20,shadowScale:.94},pagination:{el:".latest-news-carousel  .swiper-pagination",clickable:!0}});if($(".abeer-carousel").length)var abeerCarousel=new Swiper(".abeer-carousel ",{passiveListeners:!1,speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".abeer-carousel .swiper-pagination",clickable:!0},navigation:{nextEl:".abeer-carousel .swiper-button-next",prevEl:".abeer-carousel .swiper-button-prev"}});if($(".international-museums-carousel").length)var internationalCarosuel=new Swiper(".international-museums-carousel ",{passiveListeners:!1,speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".international-museums-carousel .swiper-pagination",clickable:!0}});if($(".news-details-carousel").length)var newsDetailsCarousel=new Swiper(".news-details-carousel",{passiveListeners:!1,speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".news-details-carousel .swiper-pagination",clickable:!0},navigation:{nextEl:".news-details-carousel .swiper-button-next",prevEl:".news-details-carousel .swiper-button-prev"}});if($(".meusemSwiper").length)var meusemSwiper=new Swiper(".meusemSwiper",{passiveListeners:!1,speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".meusemSwiper .swiper-pagination",clickable:!0},navigation:{nextEl:".meusemSwiper .swiper-button-next",prevEl:".meusemSwiper .swiper-button-prev"}});if($(".gallery-carousel").length)var galleryCarousel=new Swiper(".gallery-carousel",{passiveListeners:!1,speed:800,slidesPerView:1,spaceBetween:20,autoplay:{delay:5e3},loop:!0,navigation:{nextEl:".gallery-carousel .swiper-button-next",prevEl:".gallery-carousel .swiper-button-prev"},breakpoints:{640:{slidesPerView:2},768:{slidesPerView:3},992:{slidesPerView:4}}});if($(".gallery-carousel-madina").length)var galleryCarouselMadina=new Swiper(".gallery-carousel-madina",{passiveListeners:!1,speed:800,slidesPerView:1,spaceBetween:20,autoplay:{delay:5e3},loop:!0,navigation:{nextEl:".gallery-carousel-madina .swiper-button-next",prevEl:".gallery-carousel-madina .swiper-button-prev"},breakpoints:{640:{slidesPerView:2},992:{slidesPerView:3}}});if($(".targets-carousel").length)var targetsCarousel=new Swiper(".targets-carousel",{speed:800,slidesPerView:1,spaceBetween:20,autoplay:{delay:5e3},loop:!0,navigation:{nextEl:".targets-carousel .swiper-button-next",prevEl:".targets-carousel .swiper-button-prev"},passiveListeners:!1});