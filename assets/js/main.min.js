...
var prevScrollpos=window.scrollY,headerDiv=document.getElementById("header");function changeHeaderStyle(){var e=window.scrollY;prevScrollpos<e&&prevScrollpos>300?(headerDiv.style.top=-headerDiv.offsetHeight+"px",headerDiv.classList.add("fixed")):prevScrollpos<300?(headerDiv.style.top="0",headerDiv.classList.remove("fixed")):(headerDiv.style.top="0",headerDiv.classList.add("fixed")),prevScrollpos=e}window.onscroll=function(){changeHeaderStyle()},AOS.init({disable:"mobile",once:!0});var heroCarousel=new Swiper(".hero-section-carousel ",{speed:800,autoplay:{delay:15e3},pagination:{el:".hero-section-carousel  .swiper-pagination",clickable:!0}}),latestNewsCarousel=new Swiper(".latest-news-carousel ",{effect:"cube",speed:800,autoplay:{delay:5e3},loop:!0,mousewheel:{invert:!0},cubeEffect:{shadow:!0,slideShadows:!0,shadowOffset:20,shadowScale:.94},pagination:{el:".latest-news-carousel  .swiper-pagination",clickable:!0}}),abeerCarousel=new Swiper(".abeer-carousel ",{speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".abeer-carousel .swiper-pagination",clickable:!0},navigation:{nextEl:".abeer-carousel .swiper-button-next",prevEl:".abeer-carousel .swiper-button-prev"}}),internationalCarosuel=new Swiper(".international-museums-carousel ",{speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".international-museums-carousel .swiper-pagination",clickable:!0}}),newsDetailsCarousel=new Swiper(".news-details-carousel",{speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".news-details-carousel .swiper-pagination",clickable:!0},navigation:{nextEl:".news-details-carousel .swiper-button-next",prevEl:".news-details-carousel .swiper-button-prev"}}),meusemSwiper=new Swiper(".meusemSwiper",{speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".meusemSwiper .swiper-pagination",clickable:!0},navigation:{nextEl:".meusemSwiper .swiper-button-next",prevEl:".meusemSwiper .swiper-button-prev"}}),galleryCarousel=new Swiper(".gallery-carousel",{speed:800,slidesPerView:1,spaceBetween:20,autoplay:{delay:5e3},loop:!0,navigation:{nextEl:".gallery-carousel .swiper-button-next",prevEl:".gallery-carousel .swiper-button-prev"},breakpoints:{640:{slidesPerView:2},768:{slidesPerView:3},992:{slidesPerView:4}}}),galleryCarouselMadina=new Swiper(".gallery-carousel-madina",{speed:800,slidesPerView:1,spaceBetween:20,autoplay:{delay:5e3},loop:!0,navigation:{nextEl:".gallery-carousel-madina .swiper-button-next",prevEl:".gallery-carousel-madina .swiper-button-prev"},breakpoints:{640:{slidesPerView:2},992:{slidesPerView:3}}}),targetsCarousel=new Swiper(".targets-carousel",{speed:800,slidesPerView:1,spaceBetween:20,autoplay:{delay:5e3},loop:!0,navigation:{nextEl:".targets-carousel .swiper-button-next",prevEl:".targets-carousel .swiper-button-prev"}});