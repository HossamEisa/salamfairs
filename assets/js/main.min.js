...
var prevScrollpos=window.scrollY,headerDiv=document.getElementById("header");function changeHeaderStyle(){var e=window.scrollY;prevScrollpos<e&&prevScrollpos>300?(headerDiv.style.top=-headerDiv.offsetHeight+"px",headerDiv.classList.add("fixed")):prevScrollpos<300?(headerDiv.style.top="0",headerDiv.classList.remove("fixed")):(headerDiv.style.top="0",headerDiv.classList.add("fixed")),prevScrollpos=e}window.onscroll=function(){changeHeaderStyle()},AOS.init({disable:"mobile",once:!0});var latestNewsCarousel=new Swiper(".latest-news-carousel ",{effect:"cube",speed:800,autoplay:{delay:5e3},loop:!0,mousewheel:{invert:!0},cubeEffect:{shadow:!0,slideShadows:!0,shadowOffset:20,shadowScale:.94},pagination:{el:".latest-news-carousel  .swiper-pagination",clickable:!0}}),abeerCarousel=new Swiper(".abeer-carousel ",{speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".abeer-carousel .swiper-pagination",clickable:!0},navigation:{nextEl:".abeer-carousel .swiper-button-next",prevEl:".abeer-carousel .swiper-button-prev"}}),internationalCarosuel=new Swiper(".international-museums-carousel ",{speed:800,autoplay:{delay:5e3},loop:!0,pagination:{el:".international-museums-carousel .swiper-pagination",clickable:!0}});